...
def clean_ver2(sentence):
    ...
    for i in list_word:
        if i[:3] in kal_3.keys(): 
            ...
            temp.append(i)
    temp = [word for word in temp if word not in stop2] 
    return ' '.join(temp)

sys.modules[__name__] = clean_ver2 
